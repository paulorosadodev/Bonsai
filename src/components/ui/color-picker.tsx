        ...
        <div className="flex flex-col gap-2">
                ...
                {PRESET_COLORS.map((color) => {
                    ...
                    return (
                        <button
                            ...
                            className={`group relative flex size-8 items-center justify-center rounded-xl transition-transform hover:scale-110 active:scale-95 ${
                                isSelected ? "ring-2 ring-violet ring-offset-2 ring-offset-surface" : ""
                            }`}
            ...
            <div className="mt-1 flex items-center gap-2">
                ...
                <input
                    ...
                    className="size-7 cursor-pointer appearance-none rounded-lg border-0 bg-transparent p-0"
