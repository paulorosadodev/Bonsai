...
export function DesktopFab() {
    ...
    if (pathname.startsWith("/transacoes/nova")) {
        return null;
    }

    return (
        <div className="hidden lg:block fixed bottom-8 right-8 z-40">
            <Link href="/transacoes/nova" aria-label="Adicionar transação" className="group relative flex size-13 items-center justify-center rounded-full bg-violet text-ink shadow-md shadow-black/30 transition-all duration-200 hover:bg-orchid hover:shadow-lg hover:shadow-black/40 hover:scale-105 active:scale-95">
